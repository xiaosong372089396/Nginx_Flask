...
class MonitorGroups(models.Model):
...
class MonitorHostGroups(models.Model):
    group = models.ForeignKey("MonitorGroups", db_column="group_id", on_delete=models.CASCADE)
    host_id = models.IntegerField(verbose_name="主机")

    def __str__(self):
        return "%s, %s" % (self.group_id, self.host_id)
...
class MonitorHistory(models.Model):
    ...
    def __repr__(self):
        return "item id: {}, clock: {}, value: {}".format(self.itemid, self.clock, self.value)
...
class ApplicationTemplate(models.Model):
    ...
    applicationid = models.ForeignKey('Applications', models.DO_NOTHING, db_column='applicationid', related_name="ApplicationTemplate_applicationid")
    templateid = models.ForeignKey('Applications', models.DO_NOTHING, db_column='templateid')
...
class Events(models.Model):
    ...
    def __str__(self):
        return "eid: {}, tid: {}, vid: {}, ack: {}".format(self.eventid, self.objectid, self.value, self.acknowledged)
...
class Functions(models.Model):
    ...
    def __str__(self):
        return "itemid: {}, triggerid: {}".format(self.itemid, self.triggerid)
...
class GraphDiscovery(models.Model):
    graphid = models.OneToOneField('Graphs', models.DO_NOTHING, db_column='graphid', primary_key=True, related_name="GraphDiscovery_graphid")
    parent_graphid = models.ForeignKey('Graphs', models.DO_NOTHING, db_column='parent_graphid')
...
class Graphs(models.Model):
    ...
    ymin_itemid = models.ForeignKey('Items', models.DO_NOTHING, db_column='ymin_itemid', blank=True, null=True, related_name="Graphs_ymax_itemid")
    ymax_itemid = models.ForeignKey('Items', models.DO_NOTHING, db_column='ymax_itemid', blank=True, null=True)
    flags = models.IntegerField()

    def __str__(self):
        return "graph id:{}, name: {}".format(self.graphid, self.name)
...
class GraphsItems(models.Model):
    ...
    def __str__(self):
        return "graph id:{}, item id:{} ".format(self.graphid, self.itemid)
...
class HostDiscovery(models.Model):
    hostid = models.OneToOneField('Hosts', models.DO_NOTHING, db_column='hostid', primary_key=True, related_name="HostDiscovery_hostid")
    parent_hostid = models.ForeignKey('Hosts', models.DO_NOTHING, db_column='parent_hostid', blank=True, null=True)
...
class Hosts(models.Model):
    ...
    """
    索引字段
        host，status，proxy_hostid，name，maintenanceid
    主机状态
    status: {
            0: 已启用,
            1: 停用的,
    ...
    # 代理主机i，不显示在主机列表
    proxy_hostid = models.ForeignKey('self', models.DO_NOTHING, db_column='proxy_hostid', blank=True, null=True, related_name="Hosts_proxy_hostid")
    # 主机名
    ...
    def __str__(self):
        return "host: {}, hostid: {}".format(self.host, self.hostid)
...
class HostsGroups(models.Model):
    ...
    hostid = models.ForeignKey(Hosts, models.DO_NOTHING, db_column='hostid')
    groupid = models.ForeignKey(Groups, models.DO_NOTHING, db_column='groupid', related_name="host_group_id")

    def __str__(self):
        return "group id:{}, host id: {}".format(self.groupid_id, self.hostid)
...
class HostsTemplates(models.Model):
    ...
    hostid = models.ForeignKey(Hosts, models.DO_NOTHING, db_column='hostid', related_name="HostsTemplates_hostid")
...
class Interface(models.Model):
    ...
    def __str__(self):
        return "interface ip: {}".format(self.ip)
...
class InterfaceDiscovery(models.Model):
    interfaceid = models.OneToOneField(Interface, models.DO_NOTHING, db_column='interfaceid', primary_key=True, related_name="InterfaceDiscovery_interfaceid")
    parent_interfaceid = models.ForeignKey(Interface, models.DO_NOTHING, db_column='parent_interfaceid')
...
class ItemDiscovery(models.Model):
    ...
    itemid = models.ForeignKey('Items', models.DO_NOTHING, db_column='itemid', related_name="ItemDiscovery_itemid")
    parent_itemid = models.ForeignKey('Items', models.DO_NOTHING, db_column='parent_itemid')
    key_field = models.CharField(db_column='key_', max_length=255)  # Field renamed because it ended with '_'.
    lastcheck = models.IntegerField()
    ts_delete = models.IntegerField()
...
class Items(models.Model):
    ...
    def __str__(self):
        return "itemid: {},hostid: {}".format(self.itemid, self.hostid_id)
...
class ServicesLinks(models.Model):
    ...
    serviceupid = models.ForeignKey(Services, models.DO_NOTHING, db_column='serviceupid')
    servicedownid = models.ForeignKey(Services, models.DO_NOTHING, db_column='servicedownid', related_name="ServicesLinks_servicedownid")
...
class SysmapsElements(models.Model):
    ...
    elementtype = models.IntegerField()
    iconid_off = models.ForeignKey(Images, models.DO_NOTHING, db_column='iconid_off', blank=True, null=True, related_name="SysmapsElements_iconid_off")
    iconid_on = models.ForeignKey(Images, models.DO_NOTHING, db_column='iconid_on', blank=True, null=True)
    label = models.CharField(max_length=2048)
    label_location = models.IntegerField()
    x = models.IntegerField()
    y = models.IntegerField()
    iconid_disabled = models.ForeignKey(Images, models.DO_NOTHING, db_column='iconid_disabled', blank=True, null=True, related_name="SysmapsElements_iconid_disabled")
    iconid_maintenance = models.ForeignKey(Images, models.DO_NOTHING, db_column='iconid_maintenance', blank=True, null=True, related_name="SysmapsElements_iconid_maintenance")
...
class SysmapsLinks(models.Model):
    linkid = models.BigIntegerField(primary_key=True)
    sysmapid = models.ForeignKey(Sysmaps, models.DO_NOTHING, db_column='sysmapid')
    selementid1 = models.ForeignKey(SysmapsElements, models.DO_NOTHING, db_column='selementid1', related_name="SysmapsLinks_selementid1")
    selementid2 = models.ForeignKey(SysmapsElements, models.DO_NOTHING, db_column='selementid2')
    drawtype = models.IntegerField()
    color = models.CharField(max_length=6)
    label = models.CharField(max_length=2048)
...
class TriggerDepends(models.Model):
    ...
    triggerid_down = models.ForeignKey('Triggers', models.DO_NOTHING, db_column='triggerid_down', related_name="TriggerDepends_triggerid_down")
    triggerid_up = models.ForeignKey('Triggers', models.DO_NOTHING, db_column='triggerid_up')
...
class TriggerDiscovery(models.Model):
    triggerid = models.OneToOneField('Triggers', models.DO_NOTHING, db_column='triggerid', primary_key=True, unique=True)
    parent_triggerid = models.ForeignKey('Triggers', models.DO_NOTHING, db_column='parent_triggerid', related_name="TriggerDiscovery_parent_triggerid")
...
class Triggers(models.Model):
    ...
    def __str__(self):
        return "trigger_id: {}, priority: {}, lastchange: {}".format(self.triggerid, self.priority, self.lastchange)
